...
- The principles of tidy transcriptomics is to interface as much as possible commonly known manipulation and visualisation tools, rather than creating custom functions. 
- Some of the key steps in an RNA-Seq analysis are (i) filtering lowly abundant transcripts, (ii) compensating for sequencing depth, (iii) testing for differential expression
- Dimensionality reduction (PCA or MDS) plots is very important for exploring the data 
...
2. How many DE genes are there for treated vs untreated (FDR < 0.05)? What is the top DE gene by P value?  
